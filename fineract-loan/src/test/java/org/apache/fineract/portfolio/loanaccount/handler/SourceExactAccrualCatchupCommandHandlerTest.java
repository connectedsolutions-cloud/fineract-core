...
class SourceExactAccrualCatchupCommandHandlerTest {

    @Test
    void scopesCatchupAsOperationalMigration() {
        ...
        SourceExactAccrualCatchupCommandHandler handler = new SourceExactAccrualCatchupCommandHandler(writePlatformService,
        ...
        when(writePlatformService.materializeSourceExactAccruals(42L, command)).thenAnswer(invocation -> {
