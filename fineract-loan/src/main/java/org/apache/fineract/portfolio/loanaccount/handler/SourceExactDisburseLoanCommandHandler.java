...
@CommandType(entity = "LOAN", action = "SOURCEEXACTDISBURSE")
public class SourceExactDisburseLoanCommandHandler implements NewCommandSourceHandler {
        ...
        return operationalMigrationService.execute(() -> {
            try {
                ...
                dataIntegrityErrorHandler.handleDataIntegrityIssues(command, exception.getMostSpecificCause(), exception,
                        "loan.source.exact.disbursement", "Source-exact disbursement");
