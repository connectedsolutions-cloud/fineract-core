...
@CommandType(entity = "GUARANTOR", action = "SOURCEEXACTCREATE")
public class SourceExactCreateGuarantorCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return this.writePlatformService.sourceExactCreateGuarantor(command.getLoanId(), command);
    }
}
