...
@CommandType(entity = "LOAN", action = "SOURCEEXACTTERMINALADJUSTMENT")
public class SourceExactTerminalAdjustmentCommandHandler implements NewCommandSourceHandler {
