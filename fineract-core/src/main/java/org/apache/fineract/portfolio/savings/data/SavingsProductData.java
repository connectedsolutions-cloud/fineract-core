...
public final class SavingsProductData implements Serializable {
    ...
    public static SavingsProductData withCharges(final SavingsProductData product, final Collection<ChargeData> charges) {
        return copyNumbering(product, new SavingsProductData(product.id, product.name, product.shortName, product.description, product.currency,
    ...
    public static SavingsProductData withTemplate(final SavingsProductData existingProduct, final Collection<CurrencyData> currencyOptions,
        ...
        return copyNumbering(existingProduct, new SavingsProductData(existingProduct.id, existingProduct.name, existingProduct.shortName,
    ...
    private static SavingsProductData copyNumbering(final SavingsProductData source, final SavingsProductData target) {
        if (source != null) {
