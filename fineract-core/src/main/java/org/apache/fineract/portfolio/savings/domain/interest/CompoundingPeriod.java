...
public interface CompoundingPeriod {
    ...
    BigDecimal calculateInterest(SavingsCompoundingInterestPeriodType compoundingInterestPeriodType,
            ...
            BigDecimal interestRateAsFraction, SavingsInterestCalculationDaysInYearType daysInYearType,
            BigDecimal minBalanceForInterestCalculation, BigDecimal overdraftInterestRateAsFraction,
