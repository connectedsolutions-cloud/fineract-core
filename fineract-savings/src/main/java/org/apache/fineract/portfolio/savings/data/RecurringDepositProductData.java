...
public final class RecurringDepositProductData extends DepositProductData {
    ...
    public static RecurringDepositProductData withCharges(final RecurringDepositProductData existingProduct,
        ...
        return copyNumberingCode(new RecurringDepositProductData(existingProduct.id, existingProduct.name, existingProduct.shortName,
    ...
    public static RecurringDepositProductData withTemplate(final RecurringDepositProductData existingProduct,
        ...
        return copyNumberingCode(new RecurringDepositProductData(existingProduct.id, existingProduct.name, existingProduct.shortName,
                ...
                taxGroupOptions), existingProduct);
    ...
    public static RecurringDepositProductData withAccountingDetails(final RecurringDepositProductData existingProduct,
        ...
        return copyNumberingCode(new RecurringDepositProductData(existingProduct.id, existingProduct.name, existingProduct.shortName,
                ...
                existingProduct.withHoldTax, existingProduct.taxGroup, existingProduct.taxGroupOptions), existingProduct);
    }
    ...
    public static RecurringDepositProductData instance(final DepositProductData depositProductData, final boolean preClosurePenalApplicable,
        ...
        return copyNumberingCode(new RecurringDepositProductData(depositProductData.id, depositProductData.name, depositProductData.shortName,
                ...
                depositProductData.taxGroup, taxGroupOptions), depositProductData);
    }
    ...
    public static RecurringDepositProductData withInterestChart(final RecurringDepositProductData product,
        ...
        return copyNumberingCode(new RecurringDepositProductData(product.id, product.name, product.shortName, product.description, product.currency,
                ...
                product.depositAmount, product.maxDepositAmount, product.withHoldTax, product.taxGroup, product.taxGroupOptions), product);
