...
class DteJsonBuilderAggregatedLineTest {
    ...
    void buildsCuerpoDocumentoFromSingleAggregatedLine() {
        ...
        invoice.setSummary(InvoiceSummary.basic(new BigDecimal("20.00"), BigDecimal.ZERO, new BigDecimal("100.00"), new BigDecimal("120.00"),
                BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO, new BigDecimal("120.00"), new BigDecimal("120.00"),
