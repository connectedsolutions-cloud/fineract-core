...
public class FixedDepositWorkbookPopulator extends AbstractWorkbookPopulator {
    ...
    public void populate(Workbook workbook, String dateFormat) {
        ...
        setClientAndGroupDateLookupTable(fixedDepositSheet, clientSheetPopulator.getClients(), null,
                FixedDepositConstants.LOOKUP_CLIENT_NAME_COL, FixedDepositConstants.LOOKUP_ACTIVATION_DATE_COL,
    ...
    private void setDefaults(Sheet worksheet, String dateFormat) {
        ...
        try {
            for (Integer rowNo = 1; rowNo < 1000; rowNo++) {
                ...
                writeFormula(FixedDepositConstants.INTEREST_CALCULATION_COL, row,
                ...
                writeFormula(FixedDepositConstants.LOCKIN_PERIOD_COL, row, "IF(ISERROR(INDIRECT(CONCATENATE(\"Lockin_Period_\",$C"
                ...
                writeFormula(FixedDepositConstants.DEPOSIT_PERIOD_FREQUENCY_COL, row, "IF(ISERROR(INDIRECT(CONCATENATE(\"Term_Type_\",$C"
