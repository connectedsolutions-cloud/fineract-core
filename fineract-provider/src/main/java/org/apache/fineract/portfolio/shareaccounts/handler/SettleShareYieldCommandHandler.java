...
@CommandType(entity = "SHAREACCOUNT", action = "SETTLEYIELD")
public class SettleShareYieldCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(JsonCommand command) {
        return shareYieldService.settle(command.entityId(), command);
    }
}
