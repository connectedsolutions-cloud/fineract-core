...
@CommandType(entity = "SHAREACCOUNT", action = "SOURCEEXACTAPPLYADDITIONALSHARES")
public class SourceExactApplyAdditionalSharesCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(JsonCommand jsonCommand) {
        return this.operationalMigrationService
                .execute(() -> this.shareAccountWritePlatformService.applyAddtionalShares(jsonCommand.entityId(), jsonCommand));
    }
}
