...
@CommandType(entity = "SHAREACCOUNT", action = "SOURCEEXACTACTIVATE")
public class SourceExactActivateShareAccountCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(JsonCommand jsonCommand) {
        return this.operationalMigrationService
                .execute(() -> this.shareAccountWritePlatformService.activateShareAccount(jsonCommand.entityId(), jsonCommand));
    }
}
