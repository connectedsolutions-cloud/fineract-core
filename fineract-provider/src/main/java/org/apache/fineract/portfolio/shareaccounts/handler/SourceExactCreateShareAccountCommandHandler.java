...
@CommandType(entity = "SHAREACCOUNT", action = "SOURCEEXACTCREATE")
public class SourceExactCreateShareAccountCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(JsonCommand jsonCommand) {
        return this.operationalMigrationService.execute(() -> this.shareAccountWritePlatformService.createShareAccount(jsonCommand));
    }
}
