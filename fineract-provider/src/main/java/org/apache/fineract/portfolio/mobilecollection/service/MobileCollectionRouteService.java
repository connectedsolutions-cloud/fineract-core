...
public interface MobileCollectionRouteService {

    List<MobileCollectionRouteData> retrieveAll();

    MobileCollectionRouteData retrieveOne(Long routeId);

    MobileCollectionRouteTemplateData retrieveTemplate();

    MobileCollectionRouteData create(MobileCollectionRouteRequest request);

    MobileCollectionRouteData update(Long routeId, MobileCollectionRouteRequest request);
