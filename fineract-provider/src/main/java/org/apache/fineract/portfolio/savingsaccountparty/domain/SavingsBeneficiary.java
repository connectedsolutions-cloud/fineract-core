...
@Entity
@Table(name = "credesal_savings_beneficiary")
@Getter
@Setter
@NoArgsConstructor
public class SavingsBeneficiary extends AbstractPersistableCustom<Long> {
    ...
    @Column(name = "source_age", length = 15)
    private String sourceAge;
    ...
    @Column(name = "communicate_designation")
    private Boolean communicateDesignation;
