...
@CommandType(entity = "SHAREACCOUNT", action = "SOURCEEXACTAPPROVEADDITIONALSHARES")
public class SourceExactApproveAdditionalSharesCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(JsonCommand jsonCommand) {
        return this.operationalMigrationService
                .execute(() -> this.shareAccountWritePlatformService.approveAdditionalShares(jsonCommand.entityId(), jsonCommand));
    }
}
