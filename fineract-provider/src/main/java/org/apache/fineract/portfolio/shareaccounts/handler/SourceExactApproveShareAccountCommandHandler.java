...
@CommandType(entity = "SHAREACCOUNT", action = "SOURCEEXACTAPPROVE")
public class SourceExactApproveShareAccountCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(JsonCommand jsonCommand) {
        return this.operationalMigrationService
                .execute(() -> this.shareAccountWritePlatformService.approveShareAccount(jsonCommand.entityId(), jsonCommand));
    }
}
