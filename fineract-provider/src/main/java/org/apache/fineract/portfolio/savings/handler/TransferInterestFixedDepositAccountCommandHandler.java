...
@CommandType(entity = "FIXEDDEPOSITACCOUNT", action = "TRANSFERINTEREST")
public class TransferInterestFixedDepositAccountCommandHandler implements NewCommandSourceHandler {
