...
@Service
@CommandType(entity = "USER", action = "SWITCHOFFICE")
public class SwitchUserOfficeCommandHandler implements NewCommandSourceHandler {

    private final AppUserWritePlatformService writePlatformService;

    @Autowired
    public SwitchUserOfficeCommandHandler(final AppUserWritePlatformService writePlatformService) {
