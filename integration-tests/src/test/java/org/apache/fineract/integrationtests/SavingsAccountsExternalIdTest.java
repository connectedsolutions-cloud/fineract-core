...
public class SavingsAccountsExternalIdTest extends IntegrationTest {
    ...
    void updateSavingsAccountWithExternalId() {
        ...
        Response<PutSavingsAccountsAccountIdResponse> response = okR(fineractClient().savingsAccounts.update25(EXTERNAL_ID, request, ""));
    ...
    void approveSavingsAccount() {
        ...
        Response<PostSavingsAccountsAccountIdResponse> response = okR(
                fineractClient().savingsAccounts.handleCommands8(EXTERNAL_ID, request, "approve"));
    ...
    void retrieveSavingsAccountWithExternalId() {
        ...
        Response<SavingsAccountData> response = okR(fineractClient().savingsAccounts.retrieveOne30(EXTERNAL_ID, false, null, "all"));
    ...
    void undoApprovalSavingsAccountWithExternalId() {
        ...
        PostSavingsAccountsAccountIdRequest request = new PostSavingsAccountsAccountIdRequest();
        Response<PostSavingsAccountsAccountIdResponse> response = okR(
                fineractClient().savingsAccounts.handleCommands8(EXTERNAL_ID, request, "undoapproval"));
    ...
    void deleteSavingsAccountWithExternalId() {
        ...
        request.setLocale(locale);
        request.setActivatedOnDate(formattedDate);
        Response<DeleteSavingsAccountsAccountIdResponse> response = okR(fineractClient().savingsAccounts.delete21(EXTERNAL_ID));
    ...
    void retrieveSavingsAccountWithExternalIdThirdTime() {
        ...
        Response<SavingsAccountData> response = Calls
                .executeU(fineractClient().savingsAccounts.retrieveOne30(EXTERNAL_ID, false, null, "all"));
